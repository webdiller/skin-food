...
<body id="bodySelector" class="body-container">
    ...
    <main class="main main--user-cabinet">
        ...
        <div class="main__wrapper">
            ...
            <!-- navigation for 0 - 768px -->
            <div id="swiperCarouselCabinet" class="d-md-none swiper-carousel swiper-carousel--cabinet owl-carousel owl-theme">
                <div class="swiper-carousel__slide item">
                    <a href="user-cabinet.html" class="swiper-carousel__item"><span class="swiper-carousel__icon-nav demo-icon icon-user"></span> Личные данные</a>
                </div>
                <div class="swiper-carousel__slide item">
                    <a href="user-orders.html" class="swiper-carousel__item"><span class="swiper-carousel__icon-nav demo-icon icon-clock"></span> Мои заказы</a>
                </div>
                <div class="swiper-carousel__slide item">
                    <a href="user-favorite.html" class="swiper-carousel__item"><span class="swiper-carousel__icon-nav demo-icon icon-heart-circled"></span> Избранное</a>
                </div>
                <div class="swiper-carousel__slide item">
                    <a href="user-visited.html" class="swiper-carousel__item"><span class="swiper-carousel__icon-nav demo-icon icon-eye"></span> Просмотренные товары</a>
                </div>
            </div>
                ...
                <div class="navigation-cabinet__wrapper">
                    <ul class="navigation-cabinet-list">
                        <li class="navigation-cabinet-list__item active">
                            <span class="navigation-cabinet-list__icon demo-icon icon-user"></span>
                            <a href="#!" class="navigation-cabinet-list__link">личные данные</a>
                        </li>
                        <li class="navigation-cabinet-list__item">
                            <span class="navigation-cabinet-list__icon demo-icon icon-clock"></span>
                            <a href="#!" class="navigation-cabinet-list__link">мои заказы</a>
                        </li>
                        <li class="navigation-cabinet-list__item">
                            <span class="navigation-cabinet-list__icon demo-icon icon-heart-circled"></span>
                            <a href="#!" class="navigation-cabinet-list__link">избранное</a>
                        </li>
                        <li class="navigation-cabinet-list__item">
                            <span class="navigation-cabinet-list__icon demo-icon icon-eye"></span>
                            <a href="#!" class="navigation-cabinet-list__link">просмотренные товары</a>
                        </li>
                    </ul>
                </div>
            </div>
                            ...
                            <div class="notlogged__body">
                                ...
                                <div class="socials-with-payment">
                                    <div class="notlogged__socials socials-with-payment__messengers py-4">
                                        <a class="socials-with-payment__link socials-with-payment__link-fb"
                                            href="#"></a>
                                        <a class="socials-with-payment__link socials-with-payment__link-vk"
                                            href="#"></a>
                                        <a class="socials-with-payment__link socials-with-payment__link-ok"
                                            href="#"></a>
                                    </div>
                                </div>

                                <div class="notlogged__fields">
                                    <input type="text" id="" placeholder="E-mail или телефон"
                                        class="user-modal__input mb-4">

                                    <div class="search-group search-group--modal-user mb-4">
                                        <input id="" placeholder="Пароль" type="password"
                    ...
                    <div class="person user-data__person">
                        <form class="person__wrapper">
                            ...
                            <div class="person__img-wrapper">
                                <img src="https://images.pexels.com/photos/3305186/pexels-photo-3305186.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500"
                            ...
                            <div class="person__important-data">
                                <div class="form-input-group person__form-input-group">
                                    ...
                                    <input id="contactName" type="text" placeholder="Мария"
                                ...
                                <div class="form-input-group person__form-input-group">
                                    <label for="contactEmail" class="form-input-group__label "><span
                                            class="form-input-group__label-icon">*</span> e-mail</label>
                                    <input id="contactEmail" type="email" placeholder="example@gmail.com"
                                        class="form-input-group__input">
                                </div>

                                <div class="form-input-group person__form-input-group">
                                    <label for="contactCity" class="form-input-group__label "><span
                                            class="form-input-group__label-icon">*</span> Телефон</label>
                                    <input placeholder="+375291234567" type="text" class="form-input-group__input">
                                </div>
                            </div>
                            <!-- 1-3 -->
                            <div class="person__birthday-and-gender">
                                <div class="form-datepicker-group person__datepicker-group">
                                    <label class="form-datepicker-group__label" for="">Дата рождения</label>
                                </div>
                                ...
                                <div class="person__gender">
                                    ...
                                    <div class="form-gender-group person__gender-group man">
                                        <input checked="" type="radio" name="genderType" value="Мужской" id="man"
                                            class="form-gender-group__input">
                                        <label class="form-gender-group__label" for="man">Мужской</label>
                                    </div>

                                    <div class="form-gender-group person__gender-group female">
                                        <input checked="" type="radio" name="genderType" value="Женский" id="male"
                                            class="form-gender-group__input">
                        ...
                        <div class="user-address__wrapper">
                            ...
                            <form class="user-address__form">
                                    ...
                                    <div class="user-address__select-country">
                                        <div class="select-with-label">
                                            <select style="width:100%" id="country"
                                                class="user-address__select-country select-with-label__select">
                                    ...
                                    <div class="user-address__select-city">
                                        <div class="select-with-label">
                                            <select style="width:100%" id="city"
                                                class="user-address__select-city select-with-label__select">
                                ...
                                <div class="user-address__street form-input-group">
                                    ...
                                    <input placeholder="Пушкина" type="text" class="form-input-group__input">
                                </div>
                                ...
                                <div class="user-address__select-house">
                                    <div class="user-address__house form-input-group">
                                        ...
                                        <input placeholder="30" type="text" class="form-input-group__input">
                                    </div>

                                    <div class="user-address__body form-input-group">
                                        <label for="contactCity" class="form-input-group__label "><span
                                                class="form-input-group__label-icon">*</span> Корпус</label>
                                        <input placeholder="30" type="text" class="form-input-group__input">
                                    </div>
                                    ...
                                    <div class="user-address__flat form-input-group">
                                        ...
                                        <input placeholder="1" type="text" class="form-input-group__input">
                                    </div>
                                </div>
                        ...
                        <div class="bonus-account__wrapper">
                            ...
                            <div class="bonus-account__fields">
                                <div class="form-input-group bonus-account__form-input-group bonus-account__cart">
                                    <label for="contactName" class="form-input-group__label">НОМЕР БОНУСНОЙ
                                        КАРТЫ</label>
                                    <input readonly id="contactName" type="text" placeholder="220104"
                                        class="form-input-group__input">
                                </div>
                                <div class="form-input-group bonus-account__form-input-group bonus-account__balans">
                                    <label for="contactName" class="form-input-group__label">ВАШ БАЛЛАНС</label>
                                    <input readonly id="contactName" type="text" placeholder="150.00 бонусов"
                                        class="form-input-group__input">
                                </div>
                                <div class="form-input-group bonus-account__form-input-group bonus-account__discount">
                                    <label for="contactName" class="form-input-group__label">СКИДКА</label>
                                    <input readonly id="contactName" type="text" placeholder="5%"
                                        class="form-input-group__input">
                                </div>
                            </div>
                        </div>
