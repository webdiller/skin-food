...
<div id="swiperCarouselCabinet" class="d-md-none swiper-carousel swiper-carousel--cabinet owl-carousel owl-theme">
    <div class="swiper-carousel__slide item">
        <a href="user-cabinet.php" class="swiper-carousel__item"><span class="swiper-carousel__icon-nav swiper-carousel__icon-nav-user"></span> Личные данные</a>
    </div>
    <div class="swiper-carousel__slide item">
        <a href="user-orders.php" class="swiper-carousel__item"><span class="swiper-carousel__icon-nav swiper-carousel__icon-nav-orders"></span> Мои заказы</a>
    </div>
    <div class="swiper-carousel__slide item">
        <a href="user-favorite.php" class="swiper-carousel__item"><span class="swiper-carousel__icon-nav swiper-carousel__icon-nav-fav"></span> Избранное</a>
    </div>
    <div class="swiper-carousel__slide item">
        <a href="user-visited.php" class="swiper-carousel__item"><span class="swiper-carousel__icon-nav swiper-carousel__icon-nav-visited"></span> Просмотренные товары</a>
    </div>
</div>

<!-- navigation for 768px - more -->
<div class="d-none d-md-block navigation-cabinet navigation-cabinet--user-data">
