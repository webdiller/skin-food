...
<body id="bodySelector" class="body-container">
    ...
    <!-- Modal -->
    <div class="filter-modal modal fade" id="filterModal" tabindex="-1" role="dialog" aria-labelledby="filterModal"
        aria-hidden="true">
            ...
            <div class="filter-modal__content modal-content">
                ...
                <div class="filter-modal__header">
                    <div class="filter-modal__wrapper">
                        <p class="filter-modal__title">Фильтр</p>
                        <button type="button" class="filter-modal__close close demo-icon icon-cancel-1"
                ...
                <form class="filter-form">
                    <div class="filter-form__wrapper">
                        <ul class="modal-filter">
                            <li class="modal-filter__item"><a href="#!" class="modal-filter__link">Цена</a></li>
                            <li class="modal-filter__item"><a href="#!" class="modal-filter__link">Тип</a></li>
                            <li class="modal-filter__item"><a href="#!" class="modal-filter__link">Действие</a></li>
                            <li class="modal-filter__item"><a href="#!" class="modal-filter__link">Тип кожи</a></li>
                            <li class="modal-filter__item"><a href="#!" class="modal-filter__link">Возраст</a></li>
                            <li class="modal-item">
                                <a class="modal-item__link" href="#!">
                                ...
                                <a href="#!" class="modal-item__icon-link demo-icon"></a>
                            </li>
                            <li class="modal-filter__item"><a href="#!" class="modal-filter__link">Активные
                                    ингредиенты</a></li>
                        </ul>
                        <div class="filter-form__buttons">
                            <button class="filter-form__btn-reset">Сбросить</button>
                            <button class="filter-form__btn-show">показать</button>
                        </div>
                    </div>
                </form>
                                ...
                                <li class="deep-navigation__item">
                                    <div class="brands-images full-height">
                                        <a href="#" class="brands-images__link">
                                            <img class="brands-images__img"
                                                src="./img/brands/1.jpg"
                                                alt="brand-logo">
                                        </a>
                                        <a href="#" class="brands-images__link">
                                            <img class="brands-images__img"
                                                src="./img/brands/2.jpg"
                                                alt="brand-logo">
                                        </a>
                                        <a href="#" class="brands-images__link">
                                            <img class="brands-images__img"
                                                src="./img/brands/3.jpg"
                                                alt="brand-logo">
                                        </a>
                                        <a href="#" class="brands-images__link">
                                            <img class="brands-images__img"
                                                src="./img/brands/4.jpg"
                                                alt="brand-logo">
                                        </a>
                                        <a href="#" class="brands-images__link">
                                            <img class="brands-images__img"
                                                src="./img/brands/5.jpg"
                                                alt="brand-logo">
                                        </a>
                                    </div>
                                </li>
                    ...
                    <div class="products-head__wrapper">
                        ...
                        <div class="banner-info">
                            <div class="banner-info__wrapper clearfix">
                                <img src="https://static-eu.insales.ru/images/collections/1/7909/1990373/brands_1548324413_APIEU_Logo_800x800.png"
                                    alt=",rand image" class="banner-info__img">
                    ...
                    <div class="products-list__wrapper">
                        ...
                        <div class="product products-list__product">
                            <div class="product__body">
                                <a class="product__link" href="#!">
                                    <img src="./img/products/product-5.jpg" alt="сыворотка для глаз"
                                        class="product__img">
                                </a>
                                <p class="product__name">hello beauty</p>
                                <p class="product__descr">Сыворотка для кожи
                        ...
                        <div class="product products-list__product">
                            <div class="product__body">
                                <a class="product__link" href="#!">
                                    <img src="./img/products/product-6.jpg" alt="сыворотка для глаз"
                                        class="product__img">
                                </a>
                                <p class="product__name">hello beauty</p>
                                <p class="product__descr">Сыворотка для кожи
                        ...
                        <div class="product products-list__product">
                            <div class="product__body">
                                <a class="product__link" href="#!">
                                    <img src="./img/products/product-7.jpg" alt="сыворотка для глаз"
                                        class="product__img">
                                </a>
                                <p class="product__name">hello beauty</p>
                                <p class="product__descr">Сыворотка для кожи
                        ...
                        <div class="product products-list__product">
                            <div class="product__body">
                                <a class="product__link" href="#!">
                                    <img src="./img/products/product-8.jpg" alt="сыворотка для глаз"
                                        class="product__img">
                                </a>
                                <p class="product__name">hello beauty</p>
                                <p class="product__descr">Сыворотка для кожи
