                                ...
                                <div class="orders-table__tr">
                                    <div class="orders-table__th orders-table__img-with-content-th">
                                        <div class="orders-table__img-with-content">
                                            <img src="./img/products/product-10.jpg" alt="img"
                                                class="orders-table__img">
                                    ...
                                    <div class="orders-table__th orders-table__counter-th">
                                        <div class="orders-table__counter">
                                            <div class="d-md-none basket-counter">
                                                <input readonly placeholder="0" type="number"
                                                    class="basket-counter__input">
                                            </div>
                                        </div>
                                        <p class="orders-table__counter-simple-count"><span
                                                class="orders-table__number-count d-md-none">Число</span>2</p>
                                    </div>
                                    <div class="orders-table__th orders-table__number-th">
                                        <p class="orders-table__number"><span
                                                class="orders-table__number-count d-md-none">Число</span> 14</p>
                                    </div>
                                </div>
                                <div class="orders-table__tr">
                                    <div class="orders-table__th orders-table__img-with-content-th">
