                        ...
                        <form class="notlogged__wrapper">
                            ...
                            <div class="notlogged__body">
                                ...
                                <div class="notlogged__fields">
                                    <input type="text" id="" placeholder="E-mail или телефон" class="user-modal__input mb-4">

                                    <div class="search-group search-group--modal-user mb-4">
                                        <input id="" placeholder="Пароль" type="password" class="search-group__input">
                    ...
                    <div class="person user-data__person">
                        <form class="person__wrapper">
                            ...
                            <div class="person__important-data">
                                ...
                                <div class="form-input-group person__form-input-group">
                                    <label for="contactCity" class="form-input-group__label "><span class="form-input-group__label-icon">*</span> Телефон</label>
                        ...
                        <div class="user-address__wrapper">
                            ...
                            <form class="user-address__form">
                                ...
                                <div class="user-address__street form-input-group">
                                    <label for="contactCity" class="form-input-group__label "><span class="form-input-group__label-icon">*</span> Улица</label>
                                ...
                                <div class="user-address__select-house">
                                    <div class="user-address__house form-input-group">
                                        <label for="contactCity" class="form-input-group__label "><span class="form-input-group__label-icon">*</span> Дом</label>
                                        <input placeholder="30" type="text" class="form-input-group__input">
                                    </div>

                                    <div class="user-address__body form-input-group">
                                        <label for="contactCity" class="form-input-group__label "><span class="form-input-group__label-icon">*</span> Корпус</label>
                                        <input placeholder="30" type="text" class="form-input-group__input">
                                    </div>

                                    <div class="user-address__flat form-input-group">
                                        <label for="contactCity" class="form-input-group__label "><span class="form-input-group__label-icon">*</span> Квартира</label>
                            ...
                            <div class="bonus-account__fields">
                                <div class="form-input-group bonus-account__form-input-group bonus-account__cart">
                                    <label for="contactName" class="form-input-group__label">НОМЕР БОНУСНОЙ
                                        КАРТЫ</label>
                                    <input readonly id="contactName" type="text" placeholder="220104" class="form-input-group__input">
                                </div>
                                <div class="form-input-group bonus-account__form-input-group bonus-account__balans">
                                    ...
                                    <input readonly id="contactName" type="text" placeholder="150.00 бонусов" class="form-input-group__input">
                                </div>
                                <div class="form-input-group bonus-account__form-input-group bonus-account__discount">
                                    ...
                                    <input readonly id="contactName" type="text" placeholder="5%" class="form-input-group__input">
                                </div>
                            </div>
                        </div>
                    </div>
