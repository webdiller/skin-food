...
<body id="bodySelector" class="body-container">
    ...
    <main class="main main--user-favorite">
        ...
        <div class="main__wrapper">
            ...
            <div id="swiperCarouselCabinet" class="d-md-none swiper-carousel swiper-carousel--cabinet swiper-carousel--favorite swiper-carousel--bs owl-carousel owl-theme">
                <div class="swiper-carousel__slide item">
                    <a href="#!" class="swiper-carousel__item"><span class="swiper-carousel__icon-nav demo-icon icon-user"></span> Личные данные</a>
                </div>
                <div class="swiper-carousel__slide item">
                    <a href="#!" class="swiper-carousel__item"><span class="swiper-carousel__icon-nav demo-icon icon-clock"></span> Мои заказы</a>
                </div>
                <div class="swiper-carousel__slide item">
                    <a href="#!" class="swiper-carousel__item"><span class="swiper-carousel__icon-nav demo-icon icon-heart-circled"></span> Избранное</a>
                </div>
                <div class="swiper-carousel__slide item">
                    <a href="#!" class="swiper-carousel__item"><span class="swiper-carousel__icon-nav demo-icon icon-eye"></span> Просмотренные товары</a>
                </div>
            </div>
                        ...
                        <div class="favorites__list-wrapper products-list__wrapper">
                            ...
                            <div class="product products-list__product">
                                <div style="--bgColor: #EF2B50" data-status="-30 % АКЦИЯ" class="product__body">
                                    <a class="product__link" href="#!">
                                        <img src="./img/products/product-1.jpg" alt="сыворотка для глаз"
                                            class="product__img">
                                    </a>
                            ...
                            <div class="product products-list__product">
                                <div style="--bgColor: #B970E8" data-status="MUST HAVE" class="product__body">
                                    <a class="product__link" href="#!">
                                        <img src="./img/products/product-2.jpg" alt="сыворотка для глаз"
                                            class="product__img">
                                    </a>
                                    <p class="product__name">hello beauty</p>
                                    <p class="product__descr">Сыворотка для кожи
                            ...
                            <div class="product products-list__product">
                                <div style="--bgColor: #1CD169" data-status="НОВИНКА" class="product__body">
                                    <a class="product__link" href="#!">
                                        <img src="./img/products/product-3.jpg" alt="сыворотка для глаз"
                                            class="product__img">
                                    </a>
                                    <p class="product__name">hello beauty</p>
                                    <p class="product__descr">Сыворотка для кожи
                            ...
                            <div class="product products-list__product">
                                <div style="--bgColor: #F1B155" data-status="БЕСТСЕЛЛЕР" class="product__body">
                                    <a class="product__link" href="#!">
                                        <img src="./img/products/product-4.jpg" alt="сыворотка для глаз"
                                            class="product__img">
                                    </a>
                                    <p class="product__name">hello beauty</p>
                                    <p class="product__descr">Сыворотка для кожи
                    ...
                    <div class="products-pagination">
                        <div class="products-pagination__wrapper">
                            ...
                            <ul class="products-pagination__list">
                                <li class="products-pagination__item products-pagination__item-arrow"><a href="#!"
                                        class="products-pagination__link products-pagination__link-icon demo-icon icon-left-open-big"></a>
                                </li>
                                <li class="products-pagination__item active"><a href="#!"
                                        class="products-pagination__link">1</a></li>
                                <li class="products-pagination__item"><a href="#!"
                                        class="products-pagination__link">2</a>
                                </li>
                                <li class="products-pagination__item"><a href="#!"
                                        class="products-pagination__link">3</a>
                                </li>
                                <li class="products-pagination__item"><a href="#!"
                                        class="products-pagination__link">4</a>
                                </li>
                                <li class="products-pagination__item"><a href="#!"
                                        class="products-pagination__link">5</a>
                                </li>
                                <li class="products-pagination__item"><a href="#!"
                                        class="products-pagination__link">...</a>
                                </li>
                                <li class="products-pagination__item"><a href="#!"
                                        class="products-pagination__link">15</a>
                                </li>
                                <li class="products-pagination__item products-pagination__item-arrow"><a href="#!"
                                        class="products-pagination__link products-pagination__link-icon demo-icon icon-right-open-big"></a>
                                </li>
                            </ul>
                        </div>
                    </div>
