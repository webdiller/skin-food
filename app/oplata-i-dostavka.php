                                ...
                                <div class="type-payment__left">
                                    ...
                                    <div class="type-payment__item">
                                        ...
                                        <div class="type-payment__images">
                                            <img loading="lazy" class="type-payment__img" src="./img/payments/payments.jpg" alt="Виды оплат: Велкарт, Visa, Master Card">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <ul class="type-payment__cards-list cards-list">
                                        <li class="cards-list__item">
                                            <a class="cards-list__link" href="#">
                                                ...
                                                <img loading="lazy" src="./img/cards-offer/card1.jpg" alt="Карта халва" class="cards-list__img">
                                            </a>
                                        </li>
                                        <li class="cards-list__item">
                                            <a class="cards-list__link" href="#">
                                                ...
                                                <img loading="lazy" src="./img/cards-offer/card2.jpg" alt="Карта халва" class="cards-list__img">
                                            </a>
                                        </li>
                                        <li class="cards-list__item">
                                            <a class="cards-list__link" href="#">
                                                ...
                                                <img loading="lazy" src="./img/cards-offer/card3.jpg" alt="Карта халва" class="cards-list__img">
                                            </a>
                                        </li>
                                        <li class="cards-list__item">
                                            <a class="cards-list__link" href="#">
                                                ...
                                                <img loading="lazy" src="./img/cards-offer/card4.jpg" alt="Карта халва" class="cards-list__img">
                                            </a>
                                        </li>
                                        <li class="cards-list__item">
                                            <a class="cards-list__link" href="#">
                                                ...
                                                <img loading="lazy" src="./img/cards-offer/card5.jpg" alt="Карта халва" class="cards-list__img">
                                            </a>
                                        </li>
                                    </ul>
                                </div>
