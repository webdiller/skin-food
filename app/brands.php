...
<body id="bodySelector" class="body-container">
                        ...
                        <form id="regionForm" class="region-form region-modal__form">
                            ...
                            <div class="region-form__select2 select2">
                                <select style="width: 100%" class="select2__select js-example-disabled-results">
                                    <option disabled value="Введите ваш наеленный пункт" selected>Введите ваш наеленный пункт</option>
    ...
    <main class="main">
        ...
        <div class="main__wrapper">
            ...
            <ul class="brands main__brands">

                <li class="brands__item">
                    <a href="#!" class="brands__letter">A</a>
                    <ul class="result-list brands__result-list">
                        <li class="result-list__item">
                            <a href="#!" class="result-list__link">A'pieu</a>
                        </li>
                        <li class="result-list__item">
                            <a href="#!" class="result-list__link">Absolute New York</a>
                        </li>
                        <li class="result-list__item">
                            <a href="#!" class="result-list__link">Adidas</a>
                        </li>
                        <li class="result-list__item">
                            <a href="#!" class="result-list__link">American Crew</a>
                        </li>
                        <li class="result-list__item">
                            <a href="#!" class="result-list__link">Anskin</a>
                        </li>
                        <li class="result-list__item">
                            <a href="#!" class="result-list__link">Aravia Professional</a>
                        </li>
                        <li class="result-list__item">
                            <a href="#!" class="result-list__link">Art-Visage</a>
                        </li>
                        <li class="result-list__item">
                            <a href="#!" class="result-list__link">AVANT-scène</a>
                        </li>
                        <li class="result-list__item">
                            <a href="#!" class="result-list__link">AXE</a>
                        </li>
                    </ul>
                </li>

                <li class="brands__item">
                    <a href="#!" class="brands__letter">B</a>
                    <ul class="result-list brands__result-list">
                        <li class="result-list__item">
                            <a href="#!" class="result-list__link">A'pieu</a>
                        </li>
